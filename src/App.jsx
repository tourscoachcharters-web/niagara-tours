    ...
    return onSnapshot(toursCollection, (snap) => {
      if (snap.empty) {
        ...
        const seed = [
          ...
          { name: "Aerial Majesty", price: 499, category: "Luxury", capacity: 4, duration: "2 Hours", description: "The ultimate perspective. A private helicopter tour over the entire Niagara region.", itinerary: ["Private Terminal Pickup", "Champagne Welcome", "45-minute Flight", "Executive Drop-off"], image: "/tour-3.jpg" },
          { name: "Winter Wonderland", price: 149, category: "Seasonal", capacity: 12, duration: "7 Hours", description: "Witness the falls transformed into a cathedral of ice.", itinerary: ["Cozy Shuttle Departure", "Frozen Falls Photography", "Hot Cocoa & Cider Tasting", "Festival of Lights Tour"], image: "/tour-4.jpg" },
          { name: "Adventure Expedition", price: 189, category: "Adventure", capacity: 20, duration: "5 Hours", description: "Get soaked in the power. Includes Hornblower VIP and Cave of the Winds.", itinerary: ["Express Toronto Departure", "Priority Cruise Boarding", "Cave of the Winds Walk", "Whirlpool Rapids Observation"], image: "/tour-5.jpg" },
          { name: "Sommelier's Route", price: 249, category: "Culinary", capacity: 8, duration: "8 Hours", description: "A deep dive into the region's terroir with private sommelier tastings.", itinerary: ["Private Car Pickup", "Peller Estates Cellar Tour", "Farm-to-Table Luncheon", "Boutique Hidden Gems Visit"], image: "/tour-6.jpg" },
          { name: "The Midnight Gala", price: 799, category: "Private", capacity: 4, duration: "4 Hours", description: "The peak of exclusivity. Private limousine and fireworks front row.", itinerary: ["Limo Concierge Pickup", "Vintage Champagne Toast", "Private Balcony Dining", "Fireworks Front Row"], image: "/tour-7.jpg" },
          { name: "Historic Forts Tour", price: 119, category: "Heritage", capacity: 32, duration: "7 Hours", description: "Step back in time at Old Fort Erie and Fort George.", itinerary: ["Morning Departure", "Old Fort Erie Guided Tour", "Historical Reenactment Lunch", "Fort George Exploration"], image: "/tour-8.jpg" },
          { name: "Nature's Sanctuary", price: 139, category: "Eco", capacity: 14, duration: "6 Hours", description: "Explore the lush flora of the Butterfly Conservatory and pristine trails.", itinerary: ["Eco-Shuttle Departure", "Butterfly Conservatory Entry", "Guided Glen Nature Hike", "Botanical Garden Picnic"], image: "/tour-9.jpg" },
          { name: "Photographer's Lens", price: 299, category: "Luxury", capacity: 6, duration: "5 Hours", description: "Capture the falls during golden hour with a professional photographer.", itinerary: ["Golden Hour Departure", "Pro Equipment Briefing", "Exclusive Vantage Access", "Post-Processing Workshop"], image: "/tour-10.jpg" }
        ];
      ...
      <main className="flex-grow">
        {view === 'home' && (
          <>
            ...
            <section className="py-32 px-6 md:px-12 max-w-[1440px] mx-auto text-left">
